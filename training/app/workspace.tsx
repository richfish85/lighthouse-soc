  ...
  return <div className="app-shell">
    ...
    <aside className="sidebar">
      ...
      <nav aria-label="Main navigation">
        ...
        <button className={view === "guide" ? "nav active" : "nav"} onClick={() => setView("guide")}><BookOpen size={18}/> Field guide</button><a className="nav" href="/simulation"><FlaskConical size={18}/> Incident Simulator</a>
      </nav>
